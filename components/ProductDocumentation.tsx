        ...
        <div className="product-docs__content">
          ...
          <section className="docs-section" id="ai">
            ...
            <div className="docs-ai-grid">
              ...
              <article><Bomb size={22} /><h3>历史与分享图</h3><p>AI、拆弹和冷静结果组成个人市场日记；市场天气分享图还会带上广度、币圈/币股温度、FOMO、领涨领跌、行情源与北京时间。</p></article>
            </div>
