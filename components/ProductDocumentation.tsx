...
const features = [
  ...
  },
  {
    ...
    detail: "中文与英文资讯分别筛选、去重、排序并保留原文，不调用 AI 翻译；用户需要时可使用浏览器内置翻译。",
    Icon: Newspaper,
  },
  {
    href: "/live",
...
const featuresEn = [
  ...
  { href: "/hotspots", eyebrow: "Daily briefing", title: "Daily Pulse", description: "Rebuild same-day stories in Beijing time and separate facts, relevance, risk and original sources.", detail: "Chinese and English stories are filtered, deduplicated and ranked in separate original-language sections; browser translation remains optional.", Icon: Newspaper },
        ...
        <div className="product-docs__content">
          ...
          <section className="docs-section" id="workflow">
            ...
            <div className="docs-flow">
              <article><span>01</span><div><strong>先看首页精选行情</strong><p>同时查看热门币、热门币股、可独立滚动的涨幅与跌幅 TOP 15、成交量异动榜和实时市场天气。</p></div></article>
          ...
          <section className="docs-section" id="ai">
            ...
            <div className="docs-ai-grid">
              ...
              <article><Bomb size={22} /><h3>历史与分享图</h3><p>AI、拆弹和冷静结果组成个人市场日记；市场天气会按完整报告生成 1200×900 长图，保留综合温度、四项指标、六个实时领涨、三组解读、风险提醒、行情源与北京时间。</p></article>
            </div>
          ...
          <section className="docs-section" id="modes">
            ...
            <div className="docs-mode-grid">
              <article data-mode="brief"><small>Brief</small><h3>早报模式</h3><p>适合快速查看实时异动清单，并完成一分钟决策检查。</p></article>
