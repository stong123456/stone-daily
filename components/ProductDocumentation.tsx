      ...
      <div className="product-docs__layout">
        ...
        <div className="product-docs__content">
          ...
          <section className="docs-section" id="privacy">
            ...
            <ul className="docs-check-list"><li><CheckCircle size={17} />不托管资金、不发交易、不做代币授权</li><li><CheckCircle size={17} />不保存签名、余额、持仓或 API 密钥</li><li><CheckCircle size={17} />版本冲突保留两边数据并交给用户选择</li><li><CheckCircle size={17} />外部来源链接会跳转到对应网站，其隐私规则由对方负责</li></ul>
          </section>
