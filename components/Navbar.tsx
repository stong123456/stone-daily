...
const primaryItems = [
  ...
  { href: "/detox", zh: "AI 工具", en: "AI tools", Icon: Bomb },
  { href: "/watchlist", zh: "自选", en: "Watchlist", Icon: Bell },
];

const moreGroups = [
  { zh: "实时信息", en: "Live information", items: [
    { href: "/live", zh: "7×24 快讯", en: "7×24 wire", Icon: Broadcast },
  ...
  { zh: "冷静工具", en: "Calm tools", items: [
    { href: "/regret", zh: "帮我冷静", en: "Help me pause", Icon: FirstAid },
...
export function Navbar() {
  ...
  return <>
    <div className="top-utility-shell"><div className="top-utility-bar"><LiveClock /><a aria-label={isEnglish ? "Visit Stone @Stone141319 on X" : "在 X 上访问石头 @Stone141319"} className="creator-link creator-link--header" href="https://x.com/Stone141319" rel="noreferrer" target="_blank"><XLogo aria-hidden size={14} weight="fill" /><span>{isEnglish ? "X: Stone" : "X：石头"}</span><small>@Stone141319</small></a></div></div>
