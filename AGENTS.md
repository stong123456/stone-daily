...
- The purchased public portal domain is `stonedaliy.xyz` with that exact spelling. Deploy the Next.js portal as a separate Railway web service while keeping the existing market-stream service isolated.
