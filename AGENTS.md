...
- Daily hotspot copy and X-share text must be a concise social digest limited to crypto and tokenized-stock/underlying U.S.-equity stories. Exclude broad macro, mainland A-share, Hong Kong-share, technology and general regulatory stories from the shared digest while keeping them available on the full Daily Pulse page.
