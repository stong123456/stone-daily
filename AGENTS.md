...
- The homepage alone owns both moving tapes: deduplicated gainers Top 20 followed by the latest 7×24 wire. They sit at the absolute top above the Beijing-time/creator utility strip and navigation; `/markets` and `/live` must not duplicate them.
